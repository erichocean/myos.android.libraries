...
#ifdef DEBUG
//#define printf(...) __android_log_print(ANDROID_LOG_DEBUG, "cairo", __VA_ARGS__);
//#define fprintf(stderr,...) __android_log_print(ANDROID_LOG_ERROR, "cr Error", __VA_ARGS__);
//#define vfprintf(stderr, ...) __android_log_print(ANDROID_LOG_ERROR, "cr Error", __VA_ARGS__);
#else
#define printf(...)
