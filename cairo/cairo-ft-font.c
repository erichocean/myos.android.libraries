					    ...
					    cairo_ft_unscaled_font_t **out)
{
    ...
    int id = 0;
    FcResult ret;
    //printf("_cairo_ft_unscaled_font_create_for_pattern 1");
    ret = FcPatternGetFTFace (pattern, FC_FT_FACE, 0, &font_face);
    if (ret == FcResultMatch) {
        goto DONE;
    }
    //printf("_cairo_ft_unscaled_font_create_for_pattern 2");
    if (ret == FcResultOutOfMemory) {
        return _cairo_error (CAIRO_STATUS_NO_MEMORY);
    }
    ret = FcPatternGetString(pattern, FC_FILE, 0, (FcChar8 **) &filename);
    //printf("_cairo_ft_unscaled_font_create_for_pattern filename: %s", filename);
    if (ret == FcResultOutOfMemory) {
        return _cairo_error (CAIRO_STATUS_NO_MEMORY);
    }
    //printf("_cairo_ft_unscaled_font_create_for_pattern 3");
    if (ret == FcResultMatch) {
    ...
    //printf("_cairo_ft_unscaled_font_create_for_pattern 4");
...
_cairo_ft_font_face_get_implementation (void *abstract_face,
					...
					const cairo_font_options_t *options)
{
    //printf("_cairo_ft_font_face_get_implementation 1");
    cairo_ft_font_face_t *font_face = abstract_face;
     ...
     */
    if (font_face->pattern) {
        //printf("_cairo_ft_font_face_get_implementation 2");
        ...
        if (resolved != NULL) {
            ...
            //printf("_cairo_ft_font_face_get_implementation 3");
        ...
        //printf("_cairo_ft_font_face_get_implementation 4");
        ...
        //printf("_cairo_ft_font_face_get_implementation 5");
        return resolved;
    }
#endif
    //printf("_cairo_ft_font_face_get_implementation 6");
...
_cairo_ft_font_face_create_for_pattern (FcPattern *pattern)
{
    //printf("_cairo_ft_font_face_create_for_pattern 1");
    ...
    //printf("_cairo_ft_font_face_create_for_pattern 2");
    font_face->unscaled = NULL;
    font_face->next = NULL;
    ...
    //printf("_cairo_ft_font_face_create_for_pattern 3");
    font_face->resolved_font_face = NULL;
    font_face->resolved_config = NULL;
    
    _cairo_font_face_init (&font_face->base, &_cairo_ft_font_face_backend);
    printf("_cairo_ft_font_face_create_for_pattern 4");
...
#if CAIRO_HAS_FC_FONT
static cairo_status_t
_cairo_ft_font_options_substitute (const cairo_font_options_t *options, FcPattern *pattern)
{
    FcValue v;
    printf("_cairo_ft_font_options_substitute 1");
    ...
    printf("_cairo_ft_font_options_substitute 2");
    if (options->antialias != CAIRO_ANTIALIAS_DEFAULT) {
    ...
    printf("_cairo_ft_font_options_substitute 3");
    ...
    printf("_cairo_ft_font_options_substitute 4");
...
#ifdef FC_HINT_STYLE
        printf("_cairo_ft_font_options_substitute 5");
    ...
    printf("_cairo_ft_font_options_substitute 6");
    return CAIRO_STATUS_SUCCESS;
}
...
{
    printf("_cairo_ft_resolve_pattern 1");
    cairo_status_t status;
    ...
    printf("_cairo_ft_resolve_pattern 2");
    ...
    printf("_cairo_ft_resolve_pattern 3");
#ifndef RD
    ...
    printf("_cairo_ft_resolve_pattern 4");
    ...
    printf("_cairo_ft_resolve_pattern 5");
    if (unscaled == NULL) {
        printf("_cairo_ft_resolve_pattern 5.1");
        resolved = FcFontMatch (NULL, pattern, &result);
        if (!resolved) {
            printf("_cairo_ft_resolve_pattern 5.11");
    ...
    printf("_cairo_ft_resolve_pattern 6");
...
{
    //printf("cairo_ft_font_face_create_for_pattern");
    cairo_ft_unscaled_font_t *unscaled;
    cairo_font_face_t *font_face;
    cairo_ft_options_t ft_options;
    cairo_status_t status;
    ...
    status = _cairo_ft_unscaled_font_create_for_pattern (pattern, &unscaled);
    if (unlikely (status)) {
        printf("cairo_ft_font_face_create_for_pattern status: %d", status);
        return (cairo_font_face_t *) &_cairo_font_face_nil;
    }
    if (unlikely (unscaled == NULL)) {
        printf("cairo_ft_font_face_create_for_pattern unlikely (unscaled == NULL)");
    ...
    //printf("cairo_ft_font_face_create_for_pattern _get_pattern_ft_options");
    font_face = _cairo_ft_font_face_create (unscaled, &ft_options);
    //printf("cairo_ft_font_face_create_for_pattern font_face");
    _cairo_unscaled_font_destroy (&unscaled->base);
    //printf("cairo_ft_font_face_create_for_pattern _cairo_unscaled_font_destroy");
    return font_face;
}
#endif
