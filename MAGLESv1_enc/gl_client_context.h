...
struct gl_client_context_t {
	...
	virtual glMatrixMode_client_proc_t set_glMatrixMode(glMatrixMode_client_proc_t f) { printf("set_glMatrixMode"); glMatrixMode_client_proc_t retval = glMatrixMode; glMatrixMode = f; return retval;}
