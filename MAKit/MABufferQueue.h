...
//#import <ui/Fence.h>
#import <ui/GraphicBuffer.h>
//#import <gui/GraphicBufferAlloc.h>

#import <utils/String8.h>
#import <utils/Vector.h>
//#import <utils/threads.h>
#import "MABufferProducer.h"

namespace android {
    // ----------------------------------------------------------------------------
    
    class MABufferQueue : public MABufferProducer {
    public:
        ...
        MABufferQueue(bool allowSynchronousMode = true);//, const sp<IGraphicBufferAlloc>& allocator = NULL);
        virtual ~MABufferQueue();
        ...
        virtual status_t dequeueBuffer(int *buf, void** fence,
        ...
        virtual void cancelBuffer(int buf, const int& fence);
    ...
    private:
        ...
        sp<GraphicBuffer> createGraphicBuffer(uint32_t w, uint32_t h, PixelFormat format, uint32_t usage, status_t* error);
