...
namespace android {
     ...
     */
    class MABufferProducer //: public IInterface
    {
    public:
        ...
        // immediately.
        virtual status_t dequeueBuffer(int *slot, void* fence,
        ...
        // the server.
        virtual void cancelBuffer(int slot, const int& fence) = 0;
    ...
    // ----------------------------------------------------------------------------
    /*
    class MNBnBufferProducer : public MABufferProducer //BnInterface<IGraphicBufferProducer>
    {
    public:
